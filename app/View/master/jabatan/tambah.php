          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              <div class="card-body ">
                ...
                <form method="post" action="/master/jabatan/tambah">
                  <label>Id Jabatan</label>
                  <input class="form-control form-control-lg" type="text" readonly name="id" value="<?= $model['form']['id_jabatan'] ?>">
                  <br>
                  <label>Nama Jabatan</label>
                  <input class="form-control form-control-lg" type="text" placeholder="Nama Jabatan" name="nama">
                  <br>
