          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              <div class="card-body ">
                ...
                <form method="post" action="/master/jurusan/tambah">
                  <label>Id Jurusan</label>
                  <input class="form-control form-control-lg" type="text" readonly name="id" value="<?= $model['form']['id_jurusan'] ?>">
                  <br>
                  <label>Nama Jurusan</label>
                  <input class="form-control form-control-lg" type="text" placeholder="Nama Jurusan" name="nama">
                  <br>
