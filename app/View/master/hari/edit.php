          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body ">
                ...
                <form method="post" action="/master/hari/edit/<?= $model['form']['id_hari'] ?>">
                  <label>Id Hari</label>
                  <input class="form-control form-control-lg" type="text" readonly name="id" value="<?= $model['form']['id_hari'] ?>">
                  <br>
                  <label>Nama Hari</label>
                  <input class="form-control form-control-lg" type="text" placeholder="Nama Hari" name="nama" value="<?= $model['form']['nama_hari'] ?>">
                  <br>
