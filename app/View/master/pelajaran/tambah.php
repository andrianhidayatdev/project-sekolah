          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Pelajaran</h3>
              </div>
              ...
              <div class="card-body ">
                ...
                <form method="post" action="/master/pelajaran/tambah">
                  ...
                  <input class="form-control form-control-lg" type="text" placeholder="Nama Pelajaran" name="nama">
                  <br>
